...
import { ArrowLeft, Calendar, User, Building, FileText, ExternalLink, MapPin, Pencil, UserMinus, Printer } from "lucide-react";
import Loader from "../../components/common/Loader";
import { formatDate } from "../../utils/dateUtils";
import ServiceCenterModal from "../../components/Assets/ServiceCenterModal";
import PrintableAssetForm from "../../components/Assets/PrintableAssetForm";
...
export default function AssetDetails() {
    ...
    return (
        <div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <div className="flex gap-2">
                        {asset.status === "Assigned" && (
                            <button
                                onClick={handlePrint}
                                className="bg-gray-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-gray-700 transition shadow-sm font-medium"
                            >
                                <Printer size={20} /> Print Assignment
                            </button>
                        )}
                        <Link
                            to="/assets"
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                ...
                                <div className="col-span-2 border-b border-gray-100 pb-4 mb-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-500">Owner Company</label>
                                ...
                                <div className="col-span-2 pt-4 border-t border-gray-100 mt-2">
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        ...
                                        {asset.status === "Assigned" && history[0] && history[0].toCompany !== asset.companyName && (
                                            <div>
                                                <label className="block text-sm font-medium text-gray-500">Assigned Company</label>
                                                <div className="mt-1 text-sm text-gray-900 font-medium flex items-center gap-2">
                                                    <Building size={16} className="text-gray-400" />
                                                    {history[0].toCompany}
                                                </div>
            ...
            <PrintableAssetForm ref={printRef} asset={asset} />
        </div >
    );
}
